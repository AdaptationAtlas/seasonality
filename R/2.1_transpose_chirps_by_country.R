...
SaveDir<-"D:/datasets/chirps/intermediate/array_countries_dekad/temp"
CHIRPS_Dekad_Dir<-"D:/Datasets/chirps/intermediate/array_countries_dekad"
...
FILES$Year<-as.numeric(format(Dates,"%Y"))
FILES$Month<-as.numeric(format(Dates,"%m"))
FILES$Day<-as.numeric(format(Dates,"%d"))
FILES$Date<-Dates
FILES$Yday<-as.numeric(format(Dates,"%j"))
